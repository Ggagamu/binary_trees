...
binary_tree_t *BTancestor_util(binary_tree_t *root, const binary_tree_t *first,
			  const binary_tree_t *second);
void BTlevelorder_util(const binary_tree_t *tree, void (*func)(int), size_t level);
...
int BTisavl_util(const binary_tree_t *tree, int low, int hi);
